...
function PostRenderer({ contentHtml }: PostRendererProps) {
  return (
    ...
    //     prose-a:underline prose-a:text-primary-500 prose-a:decoration-primary-500 prose-a:underline-offset-4 prose-a:decoration-2 prose-a:transition-all prose-a:duration-300 prose-a:ease-in-out prose-a:hover:text-primary-600"
    //
    // />
    <article
      className="prose"
