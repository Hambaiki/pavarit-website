    ...
    >
      ...
      <FadeInOutContainer visible={dropdownOpen}>
        <div className="absolute top-[115%] right-0 shadow-xl">
          <div className="flex flex-col justify-center items-center min-w-[12rem] rounded-xl bg-neutral-100 overflow-hidden">
            {loggedIn && (
              <div className="flex flex-row items-center justify-center space-x-4 p-4">
                <div className="w-10 h-10 flex items-center justify-center rounded-full bg-neutral-100 hover:bg-neutral-200 transition-colors">
                  {user.picture ? (
                    <img
                      src={user.picture}
                      alt="user-picture"
