      ...
      <div ref={dropdownRef} className={`relative`}>
        ...
        <FadeInOutContainer
          ...
          className={`absolute overflow-hidden ${
            ...
            divide-y divide-form-menu-border
            border border-form-menu-border bg-form-menu-bg 
            shadow-md rounded-md`}
        >
          <div className="p-4">
            <p className="text-sm text-form-text-value">Search Department</p>

            <div className="relative mt-2">
              <input
                type="text"
                className={`h-10 w-full pl-12 pr-3 py-2 text-left text-sm outline-none transition-colors
                    border border-form-field-border rounded-md bg-form-field-bg text-form-text-value
                    placeholder:text-sm placeholder:text-form-text-placeholder focus:ring-0
                  `}
          ...
          <div className="divide-y divide-form-menu-border max-h-48 overflow-y-auto">
            {filteredOptions.length > 0 &&
              filteredOptions.map((option, index) => (
                <button
                  ...
                  className="flex items-center w-full px-3 h-12 text-left hover:bg-form-option-active transition"
                >
