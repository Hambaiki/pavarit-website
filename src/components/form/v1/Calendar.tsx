...
const Calendar: React.FC<CalendarProps> = ({
  ...
  return (
    <div className="bg-form-menu-bg rounded-lg shadow-lg text-sm w-80">
        ...
        <div className="p-4">
          <header className="flex items-center justify-between">
            <button
              ...
              hover:text-form-text-value transition-colors"
            >
            ...
            <div className="flex items-center space-x-2">
              <button
                ...
                className="w-5 h-5 hover:text-form-text-value disabled:text-form-text-disabled transition-colors"
              >
                <svg
                  xmlns="http://www.w3.org/2000/svg"
                  viewBox="0 0 24 24"
          ...
          <div className="grid grid-cols-7 mt-4">
            {["Su", "Mo", "Tu", "We", "Th", "Fr", "Sa"].map((day) => (
              <div key={day} className="text-center text-form-helper-hint mb-2">
                {day}
              </div>
            ))}
                  ...
                  return (
                    <div
                      ...
                      className={`flex justify-center p-1 mt-1 transition-colors ${
                        isInDateRange ? "bg-form-field-focus-ring" : ""
                      } ${
                      ...
                      <button
                        ...
                        className={`shrink-0 w-8 h-8 rounded-full transition-colors ${
                          isSelectedDay || isStartOfRange || isEndOfRange
                            ? "bg-form-field-focus text-white"
                            : isCurrentMonth
                              ? "hover:bg-form-option-active"
                              : "text-form-text-disabled"
                        } ${
                      ...
                      <button
                        ...
                        className={`shrink-0 w-8 h-8 rounded-full transition-colors ${
                          isSelectedDay
                            ...
                            : isCurrentMonth
                              ? "hover:bg-form-option-active"
                              : "text-form-text-disabled hover:bg-form-option-active/70"
                        } ${
                          isToday && isCurrentMonth
                            ? "text-form-field-focus"
                            : ""
          ...
          {applyButton && (
            <div className="flex justify-end mt-2">
              <button
                className="px-8 py-2 bg-form-field-focus hover:bg-primary-600 transition-colors text-white rounded-xl"
                onClick={handleApply}
              >
                Apply
              </button>
        ...
        <div className="p-4">
          <header>
            <button
              ...
              className="flex items-center space-x-1 hover:text-form-text-value transition-colors"
            >
              <span className="font-semibold">
                {format(currentMonth, "yyyy")}
              </span>
