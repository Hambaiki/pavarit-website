    ...
    <div className="flex flex-col space-y-2">
      ...
      <div ref={dropdownRef} className={`relative h-12`}>
        ...
        <input
          ...
          className={`w-full h-full pl-28 pr-3 py-2 border rounded-md text-left text-sm text-form-text-value outline-none transition-colors 
          ...
          >
            {phoneCodes.map((code, index) => (
              <button
                ...
                className="flex items-center h-12 px-3 py-2 space-x-2 text-form-text-value hover:bg-form-option-active"
              >
