    ...
    <div className="flex flex-col space-y-2">
      ...
      <div ref={dropdownRef} className={`relative h-8`}>
        <input
          ...
          className={`flex items-center justify-between w-full h-full pr-3 pl-8 py-2 border rounded-md text-left text-sm text-form-text-value placeholder:text-form-text-placeholder outline-none transition-colors 
